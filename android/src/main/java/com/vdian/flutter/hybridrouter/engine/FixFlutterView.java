 ...
 *
 * @author qigengxin
 * @since 2019-07-24 18:15
 */
public class FixFlutterView extends FrameLayout {
    private static final String TAG = "FixFlutterView";
    ...
    private FixFlutterView(@NonNull Context context, @Nullable AttributeSet attrs, @Nullable RenderMode renderMode, @Nullable TransparencyMode transparencyMode) {
        super(context, attrs);
...
//    }
    ...
    private void sendViewportMetricsToFlutter() {
        ...
        // FIXME 这里我修改了下 sendViewportMetrics 的逻辑，如果 size 为 zero，dart 布局会有问题
        // if the size is zero skip send viewportMetrics to flutter
